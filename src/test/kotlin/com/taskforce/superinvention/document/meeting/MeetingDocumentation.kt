...
class MeetingDocumentation: ApiDocumentationTest() {
    ...
    fun `만남 조회 기능`() {
        ...
        val result: ResultActions = this.mockMvc.perform(
                RestDocumentationRequestBuilders.get("/clubs/{clubSeq}/meetings", clubSeq)
        ...
        // then
        val andDo = result.andExpect(MockMvcResultMatchers.status().isOk)
    ...
    fun `만남 생성`() {
        val meetingAddRequestDto = MeetingAddRequestDto(
                ...
                startTimestamp = LocalDateTime.parse("2020-08-08 10:00:00"),
                endTimestamp = LocalDateTime.parse("2020-08-08 10:00:00"),
                maximumNumber = 20
        )
    }
