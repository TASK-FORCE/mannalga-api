                ...
                .andDo(MockMvcRestDocumentation.document("meeting-application", ApiDocumentUtil.getDocumentRequest(), ApiDocumentUtil.getDocumentResponse(),
                        ...
                        responseFields(
                                *ApiDocumentUtil.commonResponseField(),
                                ...
                                fieldWithPath("data.meeting").type(JsonFieldType.OBJECT).description("만남 정보"),
                                fieldWithPath("data.meeting.seq").type(JsonFieldType.NUMBER).description("만남 시퀀스"),
                                fieldWithPath("data.meeting.title").type(JsonFieldType.STRING).description("만남 제목"),
                                fieldWithPath("data.meeting.content").type(JsonFieldType.STRING).description("만남 내용"),
                                fieldWithPath("data.meeting.startTimestamp").type(JsonFieldType.STRING).description("만남 시작시간"),
                                fieldWithPath("data.meeting.endTimestamp").type(JsonFieldType.STRING).description("만남 종료시간 (시작시간 이후여야함)"),
                                fieldWithPath("data.meeting.club").type(JsonFieldType.OBJECT).description("모임 정보"),
                                fieldWithPath("data.meeting.club.seq").type(JsonFieldType.NUMBER).description("모임 시퀀스"),
                                fieldWithPath("data.meeting.club.name").type(JsonFieldType.STRING).description("모임명"),
                                fieldWithPath("data.meeting.club.description").type(JsonFieldType.STRING).description("모임 설명"),
                                fieldWithPath("data.meeting.club.maximumNumber").type(JsonFieldType.NUMBER).description("모임 최대인원"),
                                fieldWithPath("data.meeting.club.userCount").type(JsonFieldType.NULL).description("모임 현재인원 (Null able)"),
                                fieldWithPath("data.meeting.club.mainImageUrl").type(JsonFieldType.STRING).description("모임 메인 이미지"),
                                fieldWithPath("data.meeting.deleteFlag").type(JsonFieldType.BOOLEAN).description("만남 삭제 여부"),
                                fieldWithPath("data.meeting.maximumNumber").type(JsonFieldType.NUMBER).description("만남 최대 인원"),
                                fieldWithPath("data.meeting.regClubUser").type(JsonFieldType.OBJECT).description("만남 주최 모임원"),
                                fieldWithPath("data.meeting.regClubUser.seq").type(JsonFieldType.NUMBER).description("모임원 시퀀스"),
                                fieldWithPath("data.meeting.regClubUser.userSeq").type(JsonFieldType.NUMBER).description("모임원 유저 시퀀스"),
                                fieldWithPath("data.meeting.regClubUser.club").type(JsonFieldType.OBJECT).description("모임 정보"),
                                fieldWithPath("data.meeting.regClubUser.club").type(JsonFieldType.OBJECT).description("모임 정보"),
                                fieldWithPath("data.meeting.regClubUser.club.seq").type(JsonFieldType.NUMBER).description("모임 시퀀스"),
                                fieldWithPath("data.meeting.regClubUser.club.name").type(JsonFieldType.STRING).description("모임명"),
                                fieldWithPath("data.meeting.regClubUser.club.description").type(JsonFieldType.STRING).description("모임 설명"),
                                fieldWithPath("data.meeting.regClubUser.club.maximumNumber").type(JsonFieldType.NUMBER).description("모임 최대인원"),
                                fieldWithPath("data.meeting.regClubUser.club.userCount").type(JsonFieldType.NULL).description("모임 현재인원 (Null able)"),
                                fieldWithPath("data.meeting.regClubUser.club.mainImageUrl").type(JsonFieldType.STRING).description("모임 메인 이미지"),
                                fieldWithPath("data.meeting.regClubUser.roles").type(JsonFieldType.ARRAY).description("모임원 권한 정보"),
                                fieldWithPath("data.meeting.regClubUser.roles[].name").type(JsonFieldType.STRING).description("권한 이름"),
                                fieldWithPath("data.meeting.regClubUser.roles[].roleGroupName").type(JsonFieldType.STRING).description("권한 그룹 이름"),
