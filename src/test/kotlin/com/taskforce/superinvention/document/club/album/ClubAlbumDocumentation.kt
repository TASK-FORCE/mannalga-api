            ...
            .andDo(document("club-album-select-single", getDocumentRequest(), getDocumentResponse(),
                ...
                responseFields(
                    *commonResponseField(),
                    ...
                    fieldWithPath("data.image.absolutePath").type(JsonFieldType.STRING).description("이미지 절대경로"),
                    fieldWithPath("data.image.filePath").type(JsonFieldType.STRING).description("이미지 상대 경로"),
                    fieldWithPath("data.image.fileName").type(JsonFieldType.STRING).description("이미지 파일 이름"),
