...
class ClubAlbumCommentController(
    ...
    fun getClubAlbumComments(pageable: Pageable,
                             ...
                             @PathVariable clubAlbumSeq: Long): ResponseDto<Page<ClubAlbumComment>> {
        return ResponseDto(clubAlbumCommentService.getCommentList(pageable, clubSeq))
    }
    ...
    @PutMapping("/{clubAlbumCommentSeq}")
